...
export function MapToolbar({ mode, onModeChange, items, itemId, onItemChange, placementArmed, onTogglePlacement, onResetView, disabled }: MapToolbarProps) {
  return <div className="map-command-bar" aria-label="Map controls">
    ...
    <div className="map-placement-command">
      <label>
        Page to place
