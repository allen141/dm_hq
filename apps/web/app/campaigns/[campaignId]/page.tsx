...
export default function CampaignPage() {
  ...
  const [publications, setPublications] = useState<Array<{ id: string; status: string; version: number }>>([]);
