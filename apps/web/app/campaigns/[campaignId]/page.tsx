...
export default function CampaignPage() {
  ...
  async function load() {
    try { setItems((await client.items(campaignId)).items); setTemplates((await client.templates(campaignId)).templates); }
